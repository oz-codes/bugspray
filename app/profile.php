...
<section id="profile_issues">
	<header>
		<h3>
			<span id="profile_issues_num"><?php echo $profile['num_posted_issues']; ?></span>
			<span id="profile_issues_heading">issue<?php echo ($profile['num_posted_issues']!=1?'s':''); ?> posted</span>
		</h3>
		<div class="fc"></div>
	</header>
